...
namespace CheeseMVC.Controllers
{
    public class MenuController : Controller
    {
        ...
        // will have the menu/additem/[identifier]
        ...
        //in the lesson video for this project, the code queries for the actual Cheese and Menu objects
        //are represented by the given IDS. This is unnecessary, since if we have the IDs
